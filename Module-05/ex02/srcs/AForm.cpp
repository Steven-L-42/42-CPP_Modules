...
/*   Updated: 2024/01/23 19:06:01 by slippert         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
AForm::AForm(const AForm &ref) : name(ref.name), is_signed(false), req_grade(ref.req_grade), req_ex_grade(ref.req_ex_grade)
{
